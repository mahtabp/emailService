...
It supports sending email to multiple recipients, multiple cc & bcc but not the attachments or html emails.

<b> Validation </b> only applies to <u>Recipient</u> and <u>Sender</u> email addresses. The intention is not to block sending emails if there's a mistake in cc or bcc email formats.
...
<a href="http://18.191.127.172:3002/docs/">Email Service Docs (hosted on Amazon Ec2) </a>

<a href="https://siteminderchallenge.azurewebsites.net/docs/">Email Service Docs (hosted on Azure) </a>

<a href="http://localhost:3002/docs/">Local Host Docs</a>


### Setup & Run locally
the API will be hosted on port 3002 if the environment variable is not set:
http://localhost:3002
...
* Deploying to Azure was a new experience & it was a bit tricky. Deploying to Amazon EC2 was more pleasant. 
